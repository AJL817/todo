...
export default async function LoginPage({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-canvas p-6">
      <div className="card-liftable flex w-full max-w-sm flex-col gap-6 p-8 shadow-float">
        <header className="flex flex-col gap-2 mb-4">
          <h1 className="t-display-sm text-ink">목표 연동 칸반 투두</h1>
        ...
        {error && (
          <p role="alert" data-testid="login-error" className="rounded-control bg-danger-soft px-3 py-2 t-body-sm text-danger">
            {error}
          </p>
        )}
